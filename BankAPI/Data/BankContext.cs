...
public partial class BankContext : DbContext
{
     ...
     protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC27FBF852FF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC2794CED27B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC278D90D759");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC27DAB7A73C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC27ECE777CA");
